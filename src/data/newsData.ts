...
export const EXTERNAL_AUTOMOTIVE_NEWS: NewsArticle[] = [
  ...
  {
    id: "ext-kompas-baterai-rusak-motor-listrik",
    title: "Baterai Rusak, Ini yang Bisa Dilakukan Pemilik Motor Listrik",
    category: "Automotive Industry",
    date: "24 September 2026",
    author: "Kompas Otomotif",
    source: "Kompas",
    image: "https://asset.kompas.com/crops/ZhkRwWIAFcasCX9Opz6WarPJ_i0=/163x248:1591x1200/1200x800/data/photo/2026/07/07/6a4c6b7c78132.jpeg",
    excerpt: "Menggunakan motor listrik menawarkan kepraktisan serta efisiensi biaya operasional. Pengoperasiannya tergolong praktis seperti skutik konvensional, sementara pengisian daya baterai bisa dilakukan dengan mudah di rumah.",
    isExternal: true,
    url: "https://otomotif.kompas.com/read/2026/09/24/192100015/baterai-rusak-ini-yang-bisa-dilakukan-pemilik-motor-listrik"
  }
];
